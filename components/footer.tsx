export default function Footer() {
    return (
        <footer className="w-full bg-transparent backdrop-blur-md border-t border-[#D9D9D9]">
            <div className="max-w-7xl mx-auto px-4 md:px-6 py-4 md:py-6">
                <div className="flex flex-col sm:flex-row justify-between items-center gap-3 md:gap-4">
                    <p className="text-xs md:text-sm text-[#4B4B4B] text-center sm:text-left">
                    ...
                    <div className="flex items-center gap-4 md:gap-5">
                        ...
                        <a 
                            ...
                            className="text-[#4B4B4B] hover:text-gray-900 transition-colors p-1"
